...
[Sequence to Sequence]
 - 입력을 위한 인코더와 출력을 위한 디코더로 구성
 - 인코더는 원문을 디코더는 번여된 결과를 비교하며 학습
...
enc_input = tf.placeholder(tf.float32, [None, None, n_input]) # 입력값은 원핫 인코딩사용, 디코더 출력값은 인덱스 숫자 그대로 사용, 입력값 랭크가 더 높음
